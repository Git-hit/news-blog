...
export async function generateMetadata({ params }) {
  ...
  const res = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/author-pages/my-author-page/slug/${slug}`, {
...
export default async function AuthorPage({ params }) {
  ...
  const [
    ...
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/author-pages/my-author-page/slug/${slug}`, {
      cache: "no-store",
    }),
